...
cdef class LitebitProExchange(ExchangeBase):
    ...
    @property
    def litebit_auth(self) -> LitebitProAuth:
        """
        :return: LitebitProAuth class (This is unique to litebit pro market).
        Read more here: https://docs.pro.coinbase.com/?python#signing-a-message
        """
        return self._litebit_auth
    ...
    async def _api_request(self,
        ...
        """
        A wrapper for submitting API requests to Litebit Pro
