        ...
        while True:
            try:
                async with websockets.connect(LITEBIT_WS_FEED) as ws:
                    ...
                    auth_dict: Dict[str] = self._litebit_pro_auth.generate_auth_dict("get", "/users/self/verify", "")
                ...
                self.logger().error("Unexpected error with Litebit Pro WebSocket connection. "
