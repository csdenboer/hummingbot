...
class LitebitProExchange(ExchangeBase):
    ...
    async def check_network(self) -> NetworkStatus:
        ...
        """
        try:
            await self._api_request("get", constants.GET_TIME_PATH)
    ...
    async def _update_trading_rules(self):
        instruments_info = await self._api_request("get", path_url=constants.GET_MARKETS_PATH)
    ...
    async def _create_order(self,
        ...
        try:
            ...
            order_result = await self._api_request("post", constants.CREATE_ORDER_PATH, api_params, True)
    ...
    async def _update_balances(self):
        ...
        try:
            account_info = await self._api_request("get", constants.GET_BALANCES_PATH, None, True)
        except Exception:
            raise
