class Constants:
    """
    Constants class stores all of the constants required for LitebitPro connector module
    """

    # Rest API endpoints
    BASE_URL = 'https://localhost/api/v2'
    ...
    BAEE_WS_URL = 'wss://ws-eu.pusher.com:443/app/d7ebf967a9ee769e864c'
